...
public class EquipementController {
    ...
    public ResponseEntity<EquipementResponse> changeStatus(@PathVariable Long id,
    ...
    public ResponseEntity<EquipementResponse> assignParent(@PathVariable Long childId,
